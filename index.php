...
<head>
    ...
    <link rel="shortcut icon" href="images/icon-lamaranyok.png">
    <meta name=title content="Jehan &amp; Titus Wedding">
    <meta name=language content="Indonesia">
    <title>Jehan &amp; Titus Wedding</title>
    ...
    <link href="themes/evergreen/style.css?v=1.0.6" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-lg fixed-bottom navbar-light bg-light" id="bot-menu">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#story"><svg width=1em height=1em viewBox="0 0 16 16"
                    ...
                    </svg><span class="d-none d-lg-block"> Love </span></a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="#countdown"><svg width=1em height=1em viewBox="0 0 16 16"
                    ...
                    </svg><span class="d-none d-lg-block"> Count Down </span></a></li>
        </ul>
    </nav>
    <section style="background:url(uploads/original/gallery/Momentkitee-1161.jpg) center center no-repeat;"
        class="cover" id="home">
        <div class="title text-center">
            <div data-aos="fade-up" data-aos-delay="200">
                <h5 class="mt-4 mb-3 text-uppercase">Hello, We Are Getting Married </h5>
                <div class="d-flex justify-content-center">
                    <img src=themes/evergreen/images/sparator.png alt="sparator" class="mahkota">
                </div>
                <h5 class="font-weight mt-3 text-uppercase">The Wedding Of</h5>
                <h2 class="mt-5 mb-5 display-4">
                    Jehan & Titus
                </h2>
                <h5 class="font-weight">Selasa, 22 February 2022</h5>
                <p class="mt-5 mb-1">
    ...
    <section style="background:url(uploads/original/gallery/cover.jpg) center center no-repeat;"
        ...
        <div class="container">
            <header class="text-center text-white vh-100 row align-items-center justify-content-center">
                <div class="col" style="margin-top: -200px;">
                    <img src=themes/evergreen/images/sparator.png alt="sparator"
                        style="max-width:120px;max-height:120px">
                    <h3 class="mt-2">The Wedding Of</h3>
                    <h1 class="display-1 font-weight-bold mb-4">Jehan & Titus</h1>
                    <p class="lead mb-5">Selasa, 22 February 2022</p>
                </div>
            </header>
        </div>
        <div class="custom-shape-divider-bottom-1610288749">
            <img src=themes/evergreen/images/sparator-1.svg alt="">
        </div>
    </section>
            ...
            <div class="col-md-12 pt-4">
                <div style="max-width:500px;margin:auto">
                    ...
                    <table style="font-size:0.9rem;margin:auto">
                        <tbody>
                            <tr>
                                <td width=50%> <img src=image/protocol/masker.png alt="masker"
                                        style="max-width:80px"><br> Wajib Menggunakan Masker</td>
                                <td width=50%> <img src=image/protocol/distance.png alt="distance"
                                        style="max-width:80px"><br> Saling Menjaga Jarak di Dalam Acara
                                </td>
                            </tr>
                            <tr>
                                <td width=50%> <img src=image/protocol/salam.png alt="salam" style="max-width:80px"><br>
                                    Menggunakan salam namastee sebagai ganti berjabat
                                    tangan</td>
                                <td width=50%> <img src=image/protocol/wash.png alt="wash" style="max-width:80px"><br>
    ...
    <section class="couple" id="couple">
        <br><br>
        <img src=themes/evergreen/images/sparator2.png alt="list" class="mb-3" style="max-height:60px"
        ...
        <div class="container" data-aos="fade-up">
            ...
            makhluk-Nya berpasang-pasangan.<br>Ya Allah, perkenankanlah kami merangkai kasih sayang yang Kau ciptakan di
            antara putra-putri kami:<br><br>
        </div>
                ...
                <div data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-delay="100" data-aos-duration="1000"
                    ...
                    <div class="row">
                        <div class="col-12 px-5">
                            ...
                            <h2 class="mt-3">
                                <span style="font-size:1.6rem;color:#6792b7">Titus</span>
                                <span class="d-block mt-3 serif">Titus Yan Bagus P.V</span>
                            </h2>
                            <p>
                                Anak Pertama dari Keluarga<br>
                                <b>Bapak G.Bambang Sartoyo &amp; <br> Ibu Ch. Ida Noviati</b>
                            </p>
                            <!-- <p class="m-0" style="color:#6792b7">Jl. Majapahit, No 43, Sleman, Yogyakarta</p> -->
    ...
    <section class="story" id="story">
        <div class="container">
            <img src=themes/evergreen/images/sparator2.png alt="list" class="mb-3" style="max-height:50px"
                data-aos="zoom-in" data-aos-delay="100">
            <div class="d-flex w-100 align-items-center justify-content-center mb-5" data-aos="flip-up"
                data-aos-delay="200">
                <h2 class="caption">Our Love</h2>
            </div>
            <div class="col-lg-8 mx-auto">
                <div class="owl-carousel owl-theme" data-aos="fade-up" data-aos-delay="200">
                    <div class="item">
                        <h3>Akad &amp; Syukuran</h3>
                        <p>Pada Hari Selasa tanggal 22 Februari 2022 di Kediaman Mempelai Wanita
                            Jalan Lundang No.7, Kel. Parit Rantang, Kec. Payakumbuh Barat. Kota Payakumbuh.
                            Sumatera Barat</p>
                        <small><i><b>22 Februari 2022</b> - Sumatera Barat </i></small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="location" id="event"
        style="background:url(uploads/original/gallery/Momentkitee-1180.jpg) center center no-repeat;background-size: cover;">
        <div class="custom-shape-divider-top-1610288850">
            <img src=themes/evergreen/images/sparator-1.svg alt="brush">
        </div>
        <div class="container py-5">
            <img src=themes/evergreen/images/sparator.png alt="list" class="mb-3" style="max-height:50px"
                data-aos="zoom-in" data-aos-delay="100">
            <div class="d-flex w-100 align-items-center justify-content-center mb-5" data-aos="flip-up"
                data-aos-delay="200">
                    ...
                    <div class="card information h-100">
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col date">
                                    <span class="d-block">22</span> Februari
                                </div>
                                <div class="col pt-1 font-weight-bold" style="font-size:0.9rem">
                            ...
                            <p class="desc-location mt-3">
                                14:00 WIB - Selesai <br> Jalan Lundang No.7, Kel. Parit Rantang, Kec. Payakumbuh Barat.
                                Kota Payakumbuh.
                                Sumatera Barat
                            </p>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="100">
                        <a href="uploads/original/gallery/Momentkitee-1136.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1136.jpg alt="Gallery 1"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="300">
                        <a href="uploads/original/gallery/Momentkitee-1141.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1141.jpg alt="Gallery 3"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="400">
                        <a href="uploads/original/gallery/Momentkitee-1156.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1156.jpg alt="Gallery 4"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="500">
                        <a href="uploads/original/gallery/Momentkitee-1158.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1158.jpg alt="Gallery 5"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="700">
                        <a href="uploads/original/gallery/Momentkitee-1144.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1144.jpg alt="Gallery 7"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="800">
                        <a href="uploads/original/gallery/Momentkitee-1164.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1164.jpg alt="Gallery 8"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="800">
                        <a href="uploads/original/gallery/Momentkitee-1180.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1180.jpg alt="Gallery 8"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="800">
                        <a href="uploads/original/gallery/Momentkitee-1186.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1186.jpg alt="Gallery 8"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="200">
                        <a href="uploads/original/gallery/Momentkitee-1138.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1138.jpg alt="Gallery 2"
                                class="img-fluid w-100"></a>
                    </div>
                    <div class="col-md-4 col-6 py-2 px-2 frame" data-aos="zoom-in" data-aos-delay="200">
                        <a href="uploads/original/gallery/Momentkitee-1145.jpg"><img
                                src=uploads/thumbs/gallery/Momentkitee-1145.jpg alt="Gallery 2"
                                class="img-fluid w-100"></a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 mt-5">
                    <div class="videoWrapper">
                        <iframe width=560 height=349
                            src=https://www.youtube.com/embed/hG_yZXiR45k?rel=0&hd=1&modestbranding=1&autohide=1&showinfo=0&controls=0
    ...
    <section class="parallax text-center mt-5"
        style="background-image: url(uploads/original/gallery/Momentkitee-1186.jpg);">
        <div class="custom-shape-divider-top-1610288850">
            <img src=themes/evergreen/images/sparator-1.svg alt="brush">
        </div>
        <div class="container">
    ...
    <section class="guestbook" id="guestbook">
        <div class="container">
            <img src=themes/evergreen/images/sparator2.png alt="list" class="mb-2" style="max-height:50px"
                data-aos="zoom-in" data-aos-delay="100">
            <div class="d-flex w-100 align-items-center justify-content-center mb-5" data-aos="flip-up"
                data-aos-delay="200">
                <h2 class="caption">Jehan &amp; Titus</h2>
            </div>
        </div>
        <!-- <div class="container">
                ...
                <div class="card border-0">
                    <div class="card-body text-left">
                        <form method="POST" action="https://demo.datengdong.com/send/3">
                            <input type=hidden name=_token value="jslY2vhgQEH8Ee8HDXp1bRmS75qTRSUaa26BER6i">
                            <div class="form-group">
                                <label for="guestName">Nama</label>
                                <input type=text class="form-control" id="guestName" name=name value="Prof. Supardi MM"
                            ...
                            <div class="text-center">
                                <button type=submit class="btn btn-secondary">Kirim <img src=images/send-w.png
            ...
            <div class="container text-left">
                <div class="row justify-content-md-center">
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=syahrul-ansyari&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                ...
                                <p>Selamat ma broo, akhirnya menikah juga. Semoga menjadi keluarga yang sakinah,
                                    mawadah, warahmah. Aamiin.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=shinta-isnaini&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
                                ...
                                <p>Selamat atas pernikahannya Romeo &amp; Juliet! Happy to see your dream come true,
                                    guys!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=ferguso-sudarsono&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
                                ...
                                <p>Meskipun tak semudah itu aku melupakanmu, aku rela dan turut berbahagia atas
                                    pernikahanmu. Semoga Romeo bisa menjagamu dengan baik. Kalau tak bisa aku siap
                                    mengantri. Hihi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=putri-syafitri&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
                                ...
                                <p>Selamat Julietku sayaang, semoga bahagia selalu dan jangan lupa buka kado dari akuh!
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=sebastian-parto&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
                                ...
                                <p>Buah jambu Buah kedondong, uhuy akhirnya kawanku nikah dong. Semoga menjadi keluarga
                                    sakinah, mawadah, warahmah aamiin.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=erina-kaguya&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="media px-3 media-comment">
                            <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block"
                                src=https://na.ui-avatars.com/api/?name=joko-purnomo&size=50&background=1d9a79&color=ffffff
                                alt="Image Avatar">
                            <div class="media-body">
                                <div class="mb-2">
    ...
    <footer>
        <div class="container">
            <div class="col-md-12">
                <a href="https://www.instagram.com/lamaran.yok/" title="Event & Wedding Service" target="_blank"><img
                        src=images/lamaranyok.png alt="Logo lamaran.yok"></a>
                <small>Event & Wedding Service</small>
            </div>
        </div>
    </footer>
    <div style="height:50px;width:60px;position: absolute;bottom:0;z-index:-1;visibility: hidden;">
        <audio id="player" autoplay loop>
            <source src=uploads/music/11.mp3 type=audio/mp3>
        </audio>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        ...
                        <h5 class="font-bold text-center">Kirim Hadiah<br><small>Untuk Jehan &amp; Titus</small></h5>
                    </div>
                    <div class="row">
                        <div class="col-8">
                            <b>BCA </b><br>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <b>MANDIRI </b><br>
                            <span onClick='copyText(this)'>1240007187363<img src=images/copy.png
                                    style="height:13px;margin-top:-5px;cursor:pointer"></span><br> a/n Jehan Nathasa
                            Pujy <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            Dana akan terpotong oleh pihak ketiga sebesar 5%.
                        </div>
                    </div>
    ...
    <script>
        ...
        var countDownDate = new Date("22 February 2022 14:00:00").getTime(),
    ...
    <script src=themes/evergreen/custom.js></script>
    <script>
